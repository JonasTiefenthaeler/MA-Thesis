...
\chapter*{Abstract}
The behaviour of turbulent flow in rough-walled pipes is studies using the \acrfull{dns} method.
The simulation tool used is Neko, a high-order spectral element solver.
A total of nine simulations are performed.
Three different surface topographies and three different Reynolds numbers are studied.
