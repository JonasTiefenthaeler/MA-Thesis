...
\chapter*{Abstract}
The behaviour of turbulent flow in rough-walled pipes is studied using the \acrfull{dns}.
The simulation tool Neko is used, a high-order spectral element solver.
...
The generated random surface is mapped onto the mesh, such that a body-fitted simulation mesh is created.
...
Two surfaces show a reduced roughness height, with varying effective slopes.
All three surfaces are studied using three different Reynolds numbers.
The Reynolds-numbers chosen are $5300, 11700$ and $19000$, which corresponds to the canonical sooth pipe cases of the friction Reynolds-numbers $180, 360$ and $550$.

Various data is presented.
First- and second order statistics, such as mean velocity profiles, total stress budgets and Reynolds-stresses.
