...
\end{figure}
The roughness function $\Delta U^+$ over $y^+$, i.e. the Hama roughness function is plotted in \autoref{fig: Delta U+ over y+}.
The points denote the surfaces at the respective Reynolds numbers, with the colour denoting each case.
...
All cases are well below the Hama roughness functions, which implies that all cases are below the fully-rough regime.
