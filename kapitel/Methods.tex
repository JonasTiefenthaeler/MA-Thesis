...
This means, that all scales of turbulent motion are resolved from the largest eddies, down to the viscous scale.
...
This high-order approach combines the flexibility in spatial discretisation of the \acrshort{fem} and combining it with the high accuracy of spectral methods.
