...
Within the logarithmic region, the log law $U^+ = \frac{1}{\kappa}\ln{y^+} + B$, with $\kappa$ and $B$ can be chosen according to the individual case. 
In this thesis $\kappa = 0.41$ and $B = 5.2$ are used, according to \cite{pope_turbulent_2015}.
