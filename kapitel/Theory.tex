...
The wall shear stress, which is responsible for the drag in smooth cases, is defined as 
\begin{equation}
    \tau_w = \mu\frac{dU}{dy}
\end{equation}
...
It is important to note that $\langle u'_3 \rangle = 0$, as described in \cite{pope_turbulent_2015}.
...
In this thesis $\kappa = 0.41$ and $A = 5.2$ are used, according to \cite{pope_turbulent_2015}.
...
Surface roughness in real-world engineering applications shows a irregular random height distribution.
