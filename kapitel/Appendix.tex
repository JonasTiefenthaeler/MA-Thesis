...
\chapter{Energy budgets}\label{apx: Energy budgets}
\section{Energy budgets for $Re_b = 11700$}
\begin{figure}
    \centering
...
\section{Energy budgets for $Re_b = 19000$}
\begin{figure}
    \centering
    \begin{subfigure}{0.495\textwidth}
        \subcaption{}
