...
Fluid mechanics is an essential subject in all enginerring disciplines, e.g.\ mechanical-, civil- and aerospace engineering.
The analysis and prediction of flow phenomena enables the optimization of systems, such as pipelines, pumps, turbines and aircraft.
...
In particular, turbulent flows over a wall, so known as wall-bounded turbulent flows, are frequently encountered in various kinds of technical applications ZITAT.
...
Furthermore, the literature is review briefly and the topic of the thesis is explained.
